...
<html>
	...
	<body>
		...
		<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
			<tr valign="top">
				<td>
					<form action="${pageContext.request.contextPath}/addDept" id="deptForm" method="post">
						<!-- 隐藏表单，flag表示添加标记 -->
								...
								<td class="font3 fftd">
									<table>
										<tr>
											...
											<td class="font3 fftd">详细描述：<input type="text" name="deptRemark" id="remark" size="20" /></td>
										</tr>
