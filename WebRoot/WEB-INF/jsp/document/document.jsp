	...
	<script type="text/javascript">
	    $(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${pageContext.request.contextPath}/removeDocument?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	    	...
	    	$("a[id^='down_']").click(function(){
	    		...
	    		/** 下载该文档 */
	    		window.location = "${pageContext.request.contextPath}/downLoad?docId="+id;
	    	});
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="documentform" method="post" id="documentform" action="selectDocument">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	标题：<input type="text" name="docTitle" />
	    ...
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
		    <tr class="main_trbg_tit" align="center">
			 ...
			 <!-- 分页部分开始1 -->
						<pg:pager url="${pageContext.request.contextPath}/selectDocument" index="center" maxPageItems="6" maxIndexPages="10" isOffset="<%=false%>" export="pageOffset,currentPageNumber=pageNumber" scope="request">
			...
			<c:forEach items="${documents}" var="document" varStatus="stat">
				...
				<tr ondblclick="down(${document.docId});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.docId}"></td>
					 <td>${document.docTitle }</td>
					 <td>
					  	<f:formatDate value="${document.docCreateDate}" 
								type="date" dateStyle="long"/>
					  </td>
					  <td>${document.user.userName }</td>
					  <td>${document.docRemark }</td>
					 <td align="center" width="40px;"><a href="showUpdateDocument?flag=1&docId=${document.docId}">
							<img title="修改" src="${pageContext.request.contextPath}/images/update.gif"/></a>
					  </td>
					  <td align="center"  width="40px;">
					  <a href="javascript:void(0);" id="down_${document.docId }">
							<img width="20" height="20" title="下载" src="${pageContext.request.contextPath}/images/downLoad.png"/>
							</a>
					  </td>
				</tr></pg:item>
			</c:forEach>
		  ...
		  <div style="margin-top: 30px;font-size: 20px;vertical-align:middle;text-align: center;color: #000000;">
						<pg:index>
							...
							<font style="vertical-align:10;font-size: 17px;font-style:italic">一共${documents.size()}条记录</font>
						</pg:index>
					</div>
					</pg:pager>
		</td>
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	   <fkjava:pager 
	  	      ...
	  	      submitUrl="${pageContext.request.contextPath}/document/selectDocument.action?pageModel.pageIndex={0}&document.title=${document.docTitle}"
	  	      style="flickr"
	  	      />
	  </td></tr>
	</table>
