...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="addEmployee" id="employeeForm" method="post">
		 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">身份证号码：<input type="text" name="empCardId" id="cardId" size="20"/></td>
		    		</tr>
		    		<tr>
		    		...
		    		<tr>
		    			<td class="font3 fftd">学历：<input name="empEducation" id="education" size="20"/></td>
		    			<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input name="empEmail" id="email" size="20"/></td>
		    		</tr>
		    		<tr>
		    			<td class="font3 fftd">手机：<input name="empTel" id="phone" size="20"/></td>
		    			<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input name="empPhone" id="tel" size="20"/></td>
		    		</tr>
			...
			<tr>
				<td class="font3 fftd">
					政治面貌：<input name="empParty" id="party" size="40"/>&nbsp;&nbsp;
			...
			<tr>
				<td class="font3 fftd">
					...
					民&nbsp;&nbsp;&nbsp;&nbsp;族：<input name="empRace" id="race" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					所学专业：<input  name="empSpeciality" id="speciality" size="40"/>&nbsp;&nbsp;
					爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="empHobby" id="hobby" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					备&nbsp;&nbsp;&nbsp;&nbsp;注：<input name="empRemark" id="remark" size="40"/>
					&nbsp;&nbsp;所属部门：
