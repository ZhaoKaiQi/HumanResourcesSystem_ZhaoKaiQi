...
<html>
	...
	<body>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
			    <form id="noticeForm" name="noticeForm" action="updateMessage" method="post">
				  <!-- 隐藏表单，flag表示添加标记 -->
    	 			<input type="hidden" name="flag" value="2">
    	 			<input type="hidden" name="msgId" value="${message2.msgId }">
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					    <tr><td class="font3 fftd">
					                公告标题：<input type="text" name="msgTitle" size="30" id="title" value="${message2.msgTitle }"/>
						...
						<tr><td class="font3 fftd">公告内容：<br/>
							<textarea name="msgContent" cols="88" rows="11" id="content" >${message2.msgContent }</textarea>
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
