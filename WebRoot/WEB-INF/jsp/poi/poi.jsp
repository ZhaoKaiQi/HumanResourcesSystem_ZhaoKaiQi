	 	  ...
	 	  /** 给数据行绑定鼠标覆盖以及鼠标移开事件  */
	 	   ...
	 	   $("#delete").click(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   $.ligerDialog.error("请选择一个需要生成的条目！");
	 		   }else{
	 			   /** 得到用户选中的所有的需要删除的ids */
	 			   ...
	 			   $.ligerDialog.confirm("确认要生成吗?","确认生成",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "createBb?t=2&ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要生成吗?","确认生成",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "createBb?t=1&ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${pageContext.request.contextPath}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：报表管理 &gt; 报表查询</td>
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="jobform" method="post" id="jobform" action="poi?t=2">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	员工查询：<input type="text" name="empName">
					    	 <input type="submit" value="搜索"/>
					    	<!-- <input id="delete" type="button" value="删除"/> -->
					    	<c:if test="${empName!=null}"><a href="createBb?t=1">生成PDF</a></c:if>
					    	<c:if test="${empName==null}"><a id="delete2">生成PDF</a></c:if>
					    	
					    	<c:if test="${empName!=null}"><a href="createBb?t=2">生成Excel</a></c:if>
					    	<c:if test="${empName==null}"><a id="delete">生成Excel</a></c:if>
					    </td>
					  </tr>
					</table>
				</form>
