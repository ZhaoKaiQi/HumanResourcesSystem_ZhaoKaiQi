    ...
    <td>
    	 <form action="addUser" id="userForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr>
		    			...
		    			<td class="font3 fftd">密&nbsp;码：<input name="userPassWord" id="password" size="20" /></td>
		    		</tr>
			...
			<tr><td align="left" class="fftd"><input type="submit" value="添加">&nbsp;&nbsp;<input type="reset" value="取消 "><div style="color: red">${msg2}</div></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
